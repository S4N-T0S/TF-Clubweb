...
const DEFAULT_ICON_CLASS = "w-4 h-4 inline-block mr-1";

export const PlatformIcons = {
    Discord: ({ className = DEFAULT_ICON_CLASS } = {}) => <SiDiscord className={className} />,
    Embark: ({ className = DEFAULT_ICON_CLASS } = {}) => <SiEmbark className={className} />,
    Steam: ({ className = DEFAULT_ICON_CLASS } = {}) => <SiSteam className={className} />,
    PSN: ({ className = DEFAULT_ICON_CLASS } = {}) => <SiPlaystation className={className} />,
    Xbox: ({ className = DEFAULT_ICON_CLASS } = {}) => ( // MFW Simple Icons doesn't have xbox icon. -- MIT Licensed Xbox SVG @Kenan Gundogan
